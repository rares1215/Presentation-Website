...
const featuresTranslations = {
  ro: {
    ...
    generatorLabel: "GENERATOR SONIC",
    sonicLabel: "DE CĂLDURĂ",
  ...
  en: {
    ...
    generatorLabel: "SONIC HEAT",
    sonicLabel: "GENERATOR",
  ...
  fr: {
    ...
    generatorLabel: "GÉNÉRATEUR SONIQUE",
    sonicLabel: "DE CHALEUR",
  ...
  es: {
    ...
    generatorLabel: "GENERADOR SÓNICO",
    sonicLabel: "DE CALOR",
  ...
  it: {
    ...
    generatorLabel: "GENERATORE SONICO",
    sonicLabel: "DI CALORE",
