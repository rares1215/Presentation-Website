...
function WhyChooseUs() {
  ...
  const reasons = [
    ...
    },
    {
      ...
      desc: "Lorem ipsum dolor sit amet consectetur adipiscing elit. Sit amet consectetur adipiscing elit quisque faucibus ex. Adipiscing elit quisque faucibus ex sapien vitae pellentesque.c",
    },
  ];
  ...
  return (
    <>
      ...
      >
        ...
        {/* Elemente decorative */}
        <div className="absolute -top-0 left-0 w-52 h-52 bg-purple-600/20 blur-2xl rounded-full animate-pulse" />
        <div className="absolute bottom-0 right-0 w-52 h-52 bg-cyan-500/20 blur-3xl rounded-full animate-pulse delay-500" />
      </section>
    </>
  );
}
